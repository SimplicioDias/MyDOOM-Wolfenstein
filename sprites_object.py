...
class SpriteObject:
    ...
    def get_sprite_projection(self):
        ...
        heigth_shift = proj_height * self.SPRITE_HEIGHT_SHIFT
        pos = self.screen_x - self.sprite_half_width, HALF_HEIGHT - proj_height // 2 + heigth_shift
    ...
    def get_sprite(self):
        ...
        if (dx > 0 and self.player.angle > math.pi) or (dx < 0 and dy < math.pi):
            delta += math.tau
